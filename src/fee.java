...
/*The Abstract Window Toolkit is Java's original platform-dependent windowing, graphics, 
 * and user-interface widget toolkit, preceding Swing. 
 */
...
{
	/*
	 * the serialVersionUID attribute to remember versions of a Serializable class 
	...
	fee()
	{
        ...
        String language[]= {"2021","2020","2019", "2018","2017","2016", "2015", "2014","2013" };
...
//JComboBox shows a popup menu that shows a list and the user can select a option from that specified list .
        ...
        String languagess[]= { "2021","2020","2019", "2018","2017","2016", "2015", "2014" };
		...
		ImageIcon i2 = new ImageIcon("C:\\Users\\musta\\Desktop\\image1.png");
		JLabel l15= new JLabel("", i2, JLabel.CENTER);
        l15.setBounds(1000, 100, 128, 154);
		...
		area2 = new JTextArea();
		area2.setBounds(600, 540, 600, 500);
		...
		Receipt.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				if (rb3.isSelected()) 
				{
					area2.setText(area2.getText()+ "Wants to be a "
								+ "Hosteller \n");
				}
				if (rb4.isSelected())
				{
